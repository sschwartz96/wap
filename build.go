...
func build() error {
	...
	tmplObj, err := template.New("wap_gen").Parse(wapGenTemplate)
	if err != nil {
...
func register(r *httprouter.Router) {
	var err error
	tmplObj, err = template.ParseFiles("template.gohtml")
	if err != nil {
...
func createHandler(pageData Page) httprouter.Handle {
	return func(res http.ResponseWriter, req *http.Request, p httprouter.Params) {
		err := tmplObj.ExecuteTemplate(res, "template.gohtml", pageData)
		if err != nil {
